    ...
    <section class="w-screen flex items-center justify-center">
      <form class="w-11/12 md:w-1/2 xl:w-1/4" @submit.prevent="handleSubmit">
        ...
        <section class="my-2 mb-2">
          <label class="text-base02 block my-2">First Name</label>
          <input
            v-model="firstName"
        ...
        <section class="my-2 mb-2">
          <label class="text-base02 block my-2">Last Name</label>
          <input
            v-model="lastName"
            class="input border-[1px] border-blue01 focus:border-Till10101 focus:outline-none rounded-md w-full h-11 transition-all px-3 duration-300 ease-linear"
            type="text"
        ...
        <section class="my-2 mb-2">
          <label htmlFor="email" class="text-base02 block my-2">Email</label>
          <input
            v-model="email"
            class="input border-[1px] border-blue01 focus:border-Till10101 focus:outline-none rounded-md w-full h-11 transition-all px-3 duration-300 ease-linear"
            type="text"
        ...
        <p class="text-[11px]">Password must be at least 8 characters</p>
