<template>
  <section class="bg-[#F3FAFD] flex items-center justify-around flex-wrap mb-28 lg:flex-nowrap">
    <div>
      <h2
      ...
      <div class="flex items-center flex-wrap gap-10 pt-10 justify-center item-center lg:flex-nowrap">
